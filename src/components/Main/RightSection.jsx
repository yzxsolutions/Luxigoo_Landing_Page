    ...
    <div className="relative w-full h-full flex justify-center items-center">
      ...
      >
        ...
        <div className="absolute top-10 bg-white rounded-xl p-1 item1 animate-image">
          <img
            src="/Luxigoo_Landing_Page/images/item1.png"
        ...
        >
          <img
            src="/Luxigoo_Landing_Page/images/item2.png"
            alt="Travel destination"
        ...
        >
          <img
            src="/Luxigoo_Landing_Page/images/item3.png"
            alt="Travel destination"
            className="rounded-xl shadow-lg w-52 h-42 object-cover"
          />
        </div>
        ...
        >
          <img
            src="/Luxigoo_Landing_Page/images/plane.png"
            alt="Travel destination"
        ...
        <div className="absolute floating-text -bottom-4 right-4 bg-white px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
          <img
            src="/Luxigoo_Landing_Page/images/ic_baseline-flight.svg"
            alt="Flight icon"
          />
